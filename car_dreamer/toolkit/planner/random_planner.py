...
from ..carla_manager import get_vehicle_pos, get_vehicle_orientation
...
class RandomPlanner(BasePlanner):
    ...
    def __init__(self, vehicle: carla.Actor, sampling_radius=0.8):
        super(RandomPlanner, self).__init__(vehicle)
    ...
    def _compute_next_waypoint(self):
        ...
        last_waypoint = self._map.get_waypoint(carla.Location(
            last_waypoint[0], last_waypoint[1], 0
