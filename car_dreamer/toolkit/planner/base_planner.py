...
class BasePlanner(ABC):
    ...
    def from_carla_waypoint(self, waypoint):
        ...
        """
        return waypoint.transform.location.x, waypoint.transform.location.y, waypoint.transform.rotation.yaw
    ...
    def _update_waypoints_queue(self):
        ...
        planner_stats = dict(
            num_completed=num_completed, num_obsolete=num_obsolete, travel_distance=get_location_distance(self._prev_location, self._vehicle_location)
        )
