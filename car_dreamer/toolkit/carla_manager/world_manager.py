...
class WorldManager:
    ...
    def try_spawn_actor(
        self, transform: Union[carla.Transform, None] = None, blueprint: Union[carla.ActorBlueprint, None] = None
    ...
    def spawn_actor(
        self, transform: Union[carla.Transform, None] = None, blueprint: Union[carla.ActorBlueprint, None] = None, max_try_time: int = None
    ) -> carla.Actor:
        """
    ...
    def spawn_auto_actors(self, n: int, transforms: List[carla.Transform] = None, blueprints: carla.BlueprintLibrary = None) -> List[carla.Actor]:
        """
