    ...
    * ``early_lane_change``: The reward for early lane change.
    ...
    def on_reset(self) -> None:
        ...
        ego_transform = carla.Transform(
            carla.Location(x=self.nonego_spawn_point[0], y=self.ego_src[1], z=self.ego_src[2]), carla.Rotation(yaw=-90)
    ...
    def reward(self):
        ...
        info.update(
            {"p_stay_same_lane": p_stay_same_lane, "r_exceeding": r_exceeding, "r_overtake": r_overtake, "p_early_lane_change": p_early_lane_change}
        )
