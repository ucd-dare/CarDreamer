...
.. note::
   This document only describes the installation and customization of this package, but it should be used with an RL backbone. For examples of training a world model using our tasks, please refer to `CarDreamer <https://github.com/ucd-dare/car-dreamer>`_.
