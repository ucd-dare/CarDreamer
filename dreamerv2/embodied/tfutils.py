...
def sg(x): return tf.stop_gradient(x)
...
class TwoHotDist(tfd.Distribution):
    def __init__(self, dist1, dist2):
        super(TwoHotDist, self).__init__(
            dtype=tf.int32,
    ...
    def _batch_shape_tensor(self):
        return tf.broadcast_static_shape(self.dist1.batch_shape_tensor(),
                                         self.dist2.batch_shape_tensor())
